...
/* IN Only*/
CREATE PROCEDURE create_customer0(IN firstname VARCHAR(50), lastname VARCHAR(50),
...
/* IN */
CREATE PROCEDURE create_customer(IN firstname VARCHAR(50), lastname VARCHAR(50), OUT custId INT,
		OUT code SMALLINT, OUT msg VARCHAR(50))
   	MODIFIES SQL DATA DYNAMIC RESULT SETS 1
   	BEGIN ATOMIC
    	INSERT INTO customers VALUES (DEFAULT, firstname, lastname);
